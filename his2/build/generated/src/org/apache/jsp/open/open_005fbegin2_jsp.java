...
public final class open_005fbegin2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <script>\n");
      out.write("            alert(");
      out.print(studentID[0]);
      out.write(" + \" \" +");
      out.print(studentname[0]);
      out.write(" + \" \" +");
      out.print(sex[0]);
      out.write(" + \" \" +");
      out.print(age[0]);
      ...
      out.print(sign[0]);
      out.write(");\n");
      out.write("                    document.getElementById(\"studentID\").value =");
      out.print(studentID[0]);
      out.write(";\n");
      out.write("            document.getElementById(\"student_name\").value =");
      out.print(studentname[0]);
      out.write(";\n");
      out.write("            document.getElementById(\"sex\").value = ");
      out.print(sex[0]);
      out.write(";\n");
      out.write("            document.getElementById(\"age\").value =");
      out.print(age[0]);
      out.write(";\n");
      ...
      out.print(phone[0]);
      out.write(";\n");
      out.write("            document.getElementById(\"sign\").value = ");
      out.print(sign[0]);
      out.write(";\n");
      out.write("        </script>\n");
      out.write("        ");
  ...
  for (int j = 0; j < stuffname.length; j++) {
      ...
      out.write("            学号/工号：<input type=\"text\"  list=\"student\"  class=\"t3\" name=\"studentID\" id=\"studentID\" placeholder=\"未查询到相关信息\"  required=\"required\"  >&emsp;<input type=\"button\" value=\"查询\" onclick=\"select_ID()\" >\n");
      out.write("            &emsp;名字：<input type=\"text\" name=\"student_name\" id=\"student_name\" class=\"tt\"  placeholder=\"未查询到任何相关信息\"  required=\"required\" > &emsp;<input type=\"button\"  value=\"查询\" onclick=\"select_name()\" >\n");
      out.write("            <br>\n");
      out.write("            <br>\n");
      out.write("            &emsp;性别：<input type=\"text\" name=\"sex\"  class=\"tt\" id=\"sex\" required=\"required\" >\n");
      out.write("            &emsp;年龄：<input type=\"text\" name=\"age\"  class=\"tt\" id=\"age\"  required=\"required\">\n");
      out.write("            &emsp;专业：<input type=\"text\" name=\"major\"  class=\"t2\" id=\"major\"  required=\"required\">\n");
      out.write("            &emsp;联系方式：<input type=\"text\" name=\"phone\"  class=\"tt\" id=\"phone\"  required=\"required\">\n");
      out.write("            <input type=\"hidden\" name=\"sign\"  id=\"sign\" >\n");
      out.write("\n");
